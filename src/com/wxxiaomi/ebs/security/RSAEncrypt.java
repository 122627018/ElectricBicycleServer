package com.wxxiaomi.ebs.security;
...
public class RSAEncrypt {  
    ...
    public static String loadPrivateKeyByResource() throws Exception {  
        try {  
        	InputStream is = RSAEncrypt.class.getClassLoader().getResourceAsStream("privateKey.keystore");
