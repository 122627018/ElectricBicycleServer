...
function sendGetRequest(data, callback) {
	window.WebViewJavascriptBridge.callHandler('sendGet', data, function(data) {
		callback(data);
	});
}

function sendPostRequest(data, callback) {
	window.WebViewJavascriptBridge.callHandler('sendPost', data,
			function(data) {
				callback(data);
			});
}
...
function showLog(data) {
	window.WebViewJavascriptBridge.callHandler('showLog', data, null);
}
